...
route.post('/hoduoutcome', async (req, res) => 
    {
        const { category, department, deptId , semester, section, academicYear } = req.body;
        // console.log( category, department, deptId , semester, section, academicYear)
        try 
        {
            const students = await studentmaster.findAll(
            {
...
//----------------------------------------------------
//coursehandle outcome
route.post('/coursereportuoutcome', async (req, res) => {
    try {
        const { academicYear, categories, departments, selectedClass, selectedSection, selectedSemester } = req.body;
        console.log(academicYear, categories, departments, selectedClass, selectedSection, selectedSemester);
        res.json("Data get");
    } catch (er) {
...
route.get('/courseid', async (req, res) => {
    try {
        ...
        // console.log("Received query params:", { academicYear, categories, departments });
...
// getting outcome data from front
route.post('/hoduoutcome', async (req, res) => {
    try {
        const { academicYear, categories, departments, selectedClass, selectedSection, selectedSemester } = req.body;
        console.log(academicYear, categories, departments, selectedClass, selectedSection, selectedSemester);
